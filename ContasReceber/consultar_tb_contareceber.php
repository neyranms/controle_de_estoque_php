...
echo "<tr><td>".$row["cr_codigo"]."</td><td>".$row["cr_valorconta"]."</td>
	<td>".$row["cr_datavencimento"]."</td><td>".$row["cr_datarecebimento"]."</td>
	<td>".$row["nf_codigo"]."</td><td>".$row["cr_observacoes"]."</td></tr><br>";
	}
	echo "</table></center>";
