...
Data Venda:<br>
<input type="text" name="ven_datavenda"><br><br> 
Data Compra:<br>
<input type="text" name="ven_valortotal"><br><br>
...
Funcionario:<br><select size="1" name="fun_codigo">
<?php
...
Observacoes:<br>
<input type="text" name="ven_observacoes"><br><br>
